    ...
    <div class="card">
        <div class="form-container2">
            <form id="code-verification-form" class="form2">
                ...
                <input type="text" class="form-control" id="verification-code" placeholder="Enter Code" required>
                <button type="button" id="verify-code" class="button-caption button button-solid-light transition-el transition-el-5">Verify Code</button>
            </form>
        </div>
    </div>
</div>
...
<div class="form-container">
    <form id="local-form" class="form form-dark notify-form" style="display: none;">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="input_local_first_name" name="input_local_first_name" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="input_local_last_name" name="input_local_last_name" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label for="input_department">NIB Number</label>
                <input type="number" class="form-control" id="input_local_nib" name="input_local_nib" placeholder="000000">
            </div>
            <div class="col-md-4">
                <label for="input_department">Your Department</label>
                <input type="text" class="form-control" id="input_local_department" name="input_local_department" disabled>
            </div>
        ...
        <div class="row">
            <!-- First column -->
            <div class="col-md-6">
                <label for="conference_photo">Upload Photo ID *</label>
                <input type="file" accept=".jpg, .jpeg, .png" id="input_local_badge_photo" name="input_local_badge_photo" required>
                <label for="upload_invite1">Accepts .jpg, .jpeg, .png</label>
            </div>
            <div class="col-md-6">
                <label for="conference_photo2">Preview</label>
        ...
        <div class="row">
            <!-- First column -->
            <div class="col-md-6">
                <label for="conference_photo">Upload Government ID *</label>
                <input type="file" accept=".jpg, .jpeg, .png" id="input_local_govid_photo" name="input_local_govid_photo" required>
                <label for="upload_invite1">Accepts .jpg, .jpeg, .png</label>
            </div>
            <div class="col-md-6">
                <label for="conference_photo2">Preview</label>
        ...
        <div class="text-center mt-3">
            <input type="submit" class="button-caption button button-solid-light transition-el transition-el-5"
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    $('html, body').animate({
                        scrollTop: $('#local-form').offset().top
...
<style>
    ...
    .form-container2 {
        /* You can adjust this to style the form container */
    }

    .form2 {
        /* You can adjust this to style the form itself */
    }

    .form-control {
        /* Your existing styles for form controls */
    }
