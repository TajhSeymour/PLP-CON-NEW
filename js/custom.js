...
$(function () {
  ...
  if (bgndKenburns.length) {
    bgndKenburns.vegas({
      ...
      slides: [
        { src: "https://dummyimage.com/100x1200/3d3d3d/7a7a7a" },
  ...
  /* The above code is using the jQuery Countdown plugin to create a countdown timer. It is targeting an
 element with the id "countdown" and setting the countdown until a specific date and time (August
 21, 2023). The format of the countdown is set to display the number of days remaining. 
 
 0=Janurary 11 = December  -4 EST Time Zone */
  $("#countdown").countdown({
    until: $.countdown.UTCDate(-4, 2023, 10, 9),
    format: "D",
  });
  // --------------------------------------------- //
  // KBW-Countdown End
