                        ...
                        <div class="card" id="ticketsList">
                            <div class="card-header border-0">
                                <div class="d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1">Tourist Special Food Needs</h5>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tourist-info').DataTable({
            ...
            "ajax": {
                "url": "/api/dashboard/fetch_data/get_registrants_foreign_tb_food_special_needs.php",
                "type": "GET"
            },
            "dom": 'lBfrtip',
        ...
        $('#tourist-info tbody').on('click', 'tr', function() {
            ...
            const food_restriction = rowData.food_restriction;
            const food_allergies = rowData.food_allergies;
            ...
            sessionStorage.setItem('food_restriction', food_restriction);
            sessionStorage.setItem('food_allergies', food_allergies);

            console.log(id, first_name, middle_name, last_name, nationality, food_restriction, food_allergies);
            ...
            const displayFoodRestrictionElements = document.querySelectorAll('.food_restriction')
            displayFoodRestrictionElements.forEach(element => element.value = food_restriction);
