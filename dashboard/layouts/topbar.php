            ...
            <div class="d-flex">
                ...
                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input disabled type="text"  class="form-control" placeholder="Search..." autocomplete="off"
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img id="header-lang-img" src="assets/images/flags/bs.svg" alt="Header Language" height="20"
                            class="rounded">
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="?lang=en" class="dropdown-item notify-item language py-2" data-lang="en"
                            title="English">
                            <img src="assets/images/flags/bs.svg" alt="user-image" class="me-2 rounded" height="18">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    <button disabled type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="logout.php"><i
                                ...
                                class="align-middle"><?=$lang['t-logout']?></span></a>
                    </div>
                </div>
            </div>
        </div>
